...
# 1 "/opt/tools/xilinx/Vivado/2019.1/common/technology/autopilot/etc/autopilot_ssdm_op.h" 1
# 305 "/opt/tools/xilinx/Vivado/2019.1/common/technology/autopilot/etc/autopilot_ssdm_op.h"
...
# 1 "/opt/tools/xilinx/Vivado/2019.1/lnx64/tools/clang/bin/../lib/clang/3.1/include/stddef.h" 1 3 4
# 31 "/opt/tools/xilinx/Vivado/2019.1/lnx64/tools/clang/bin/../lib/clang/3.1/include/stddef.h" 3 4
...
# 1 "/opt/tools/xilinx/Vivado/2019.1/lnx64/tools/clang/bin/../lib/clang/3.1/include/stdarg.h" 1 3 4
# 30 "/opt/tools/xilinx/Vivado/2019.1/lnx64/tools/clang/bin/../lib/clang/3.1/include/stdarg.h" 3 4
typedef __builtin_va_list va_list;
# 48 "/opt/tools/xilinx/Vivado/2019.1/lnx64/tools/clang/bin/../lib/clang/3.1/include/stdarg.h" 3 4
...
# 13 "./lstm_kernel.h" 2
# 1 "/opt/tools/xilinx/Vivado/2019.1/common/technology/autopilot/ap_cint.h" 1
# 83 "/opt/tools/xilinx/Vivado/2019.1/common/technology/autopilot/ap_cint.h"
# 1 "/opt/tools/xilinx/Vivado/2019.1/common/technology/autopilot/etc/autopilot_apint.h" 1
# 57 "/opt/tools/xilinx/Vivado/2019.1/common/technology/autopilot/etc/autopilot_apint.h"
# 1 "/opt/tools/xilinx/Vivado/2019.1/common/technology/autopilot/etc/autopilot_dt.h" 1
# 97 "/opt/tools/xilinx/Vivado/2019.1/common/technology/autopilot/etc/autopilot_dt.h"
# 1 "/opt/tools/xilinx/Vivado/2019.1/common/technology/autopilot/etc/autopilot_dt.def" 1
...
# 98 "/opt/tools/xilinx/Vivado/2019.1/common/technology/autopilot/etc/autopilot_dt.h" 2
# 1 "/opt/tools/xilinx/Vivado/2019.1/common/technology/autopilot/etc/autopilot_dt_ext.def" 1
...
# 99 "/opt/tools/xilinx/Vivado/2019.1/common/technology/autopilot/etc/autopilot_dt.h" 2
# 108 "/opt/tools/xilinx/Vivado/2019.1/common/technology/autopilot/etc/autopilot_dt.h"
# 1 "/opt/tools/xilinx/Vivado/2019.1/common/technology/autopilot/etc/autopilot_dt.def" 1
...
# 109 "/opt/tools/xilinx/Vivado/2019.1/common/technology/autopilot/etc/autopilot_dt.h" 2
# 1 "/opt/tools/xilinx/Vivado/2019.1/common/technology/autopilot/etc/autopilot_dt_ext.def" 1
...
# 110 "/opt/tools/xilinx/Vivado/2019.1/common/technology/autopilot/etc/autopilot_dt.h" 2
# 131 "/opt/tools/xilinx/Vivado/2019.1/common/technology/autopilot/etc/autopilot_dt.h"
typedef int __attribute__ ((bitwidth(64))) int64;
typedef unsigned int __attribute__ ((bitwidth(64))) uint64;
# 58 "/opt/tools/xilinx/Vivado/2019.1/common/technology/autopilot/etc/autopilot_apint.h" 2
# 1 "/opt/tools/xilinx/Vivado/2019.1/common/technology/autopilot/etc/autopilot_ssdm_bits.h" 1
# 59 "/opt/tools/xilinx/Vivado/2019.1/common/technology/autopilot/etc/autopilot_apint.h" 2
# 84 "/opt/tools/xilinx/Vivado/2019.1/common/technology/autopilot/ap_cint.h" 2
# 14 "./lstm_kernel.h" 2
...
void lstm_kernel(
 ...
 uint16 max_v,
 uint16 min_v,
 int16 weight[20*4+20*20*4+20*4+20 +20],
...
{_ssdm_SpecArrayDimSize(weight, 1800);
 static int16 lut_sigmoid[1024] = {
...
_ssdm_op_SpecInterface(weight, "bram", 0, 0, "", 0, 0, "", "", "", 0, 0, 0, 0, "", "");
_ssdm_op_SpecResource(weight, "", "RAM_1P_BRAM", "", -1, "", "", "", "", "");

 static int16 h_state[20] = {0};
    static int16 c_state[20] = {0};
_ssdm_op_SpecReset( &h_state, 1,  "");
_ssdm_op_SpecReset( &c_state, 1,  "");

 int16 lstm_output;
    int i, j, k;

    uint32 mult_sampleinput;
    uint16 norm_sampleinput;

    static int16 weight_l[4+4*20 +4][20];


    int16 lstm_state[20][4];


    if (mode == 1) {

        for (j = 0; j < 20; ++j) {
            weight_l[0][j] = (int16)weight[20*0+j];
         weight_l[1][j] = (int16)weight[20*1+j];
         weight_l[2][j] = (int16)weight[20*2+j];
         weight_l[3][j] = (int16)weight[20*3+j];
        }

        for (i = 0; i < 20; ++i) {
         for (j = 0; j < 20; ++j) {
          weight_l[4+4*i+0][j] = (int16)weight[20*4+20*20*0+j*20 +i];
          weight_l[4+4*i+1][j] = (int16)weight[20*4+20*20*1+j*20 +i];
          weight_l[4+4*i+2][j] = (int16)weight[20*4+20*20*2+j*20 +i];
          weight_l[4+4*i+3][j] = (int16)weight[20*4+20*20*3+j*20 +i];
         }
        }

        for (j = 0; j < 20; ++j) {
         weight_l[4+4*20 +0][j] = (int16)weight[20*4+20*20*4+20*0+j];
         weight_l[4+4*20 +1][j] = (int16)weight[20*4+20*20*4+20*1+j];
         weight_l[4+4*20 +2][j] = (int16)weight[20*4+20*20*4+20*2+j];
         weight_l[4+4*20 +3][j] = (int16)weight[20*4+20*20*4+20*3+j];
        }
    }
    else {
...
_ssdm_Unroll(0,0,0, "");
 c_state[k] = 0;
     ...
     mult_sampleinput = (uint32) ((sampleinput - min_v) << 16);
     norm_sampleinput = (uint16) (mult_sampleinput / (max_v - min_v));

     for (i = 0; i < 4; ++i) {
_ssdm_op_SpecPipeline(-1, 1, 1, 0, "");
 for (j = 0; j < 20; ++j) {

       lstm_state[j][i] = (norm_sampleinput * weight_l[i][j]) >> 12;
      }
     }
...
_ssdm_op_SpecPipeline(-1, 1, 1, 0, "");
 for (j = 0; j < 20; ++j) {
        ...
        lstm_state[j][i] += ((h_state[k] * weight_l[4+4*k+i][j]) >> 12);
       }
      }
     }
...
_ssdm_op_SpecPipeline(-1, 1, 1, 0, "");
 for (j = 0; j < 20; ++j) {
       ...
       lstm_state[j][i] += weight_l[4+4*20 +i][j];
       lstm_state[j][i] = lstm_state[j][i] >> 5;
        ...
        for (j = 0; j < 20; ++j) {
_ssdm_op_SpecPipeline(-1, 1, 1, 0, "");
 if (lstm_state[j][0] >= 1024)
             lstm_state[j][0] = 4095;
            if ((lstm_state[j][0] >= 0) && (lstm_state[j][0] < 1024))
             lstm_state[j][0] = lut_sigmoid[lstm_state[j][0]];
            if ((lstm_state[j][0] > -1024) && (lstm_state[j][0] < 0))
             lstm_state[j][0] = 4096 - lut_sigmoid[-lstm_state[j][0]];
            if (lstm_state[j][0] <= -1024)
             lstm_state[j][0] = 1;

            if (lstm_state[j][1] >= 1024)
             lstm_state[j][1] = 4095;
            if ((lstm_state[j][1] >= 0) && (lstm_state[j][1] < 1024))
             lstm_state[j][1] = lut_sigmoid[lstm_state[j][1]];
            if ((lstm_state[j][1] > -1024) && (lstm_state[j][1] < 0))
             lstm_state[j][1] = 4096 - lut_sigmoid[-lstm_state[j][1]];
            if (lstm_state[j][1] <= -1024)
             lstm_state[j][1] = 1;

            if (lstm_state[j][2] >= 1024)
             lstm_state[j][2] = 4095;
            if ((lstm_state[j][2] >= 0) && (lstm_state[j][2] < 1024))
             lstm_state[j][2] = lut_sigmoid[lstm_state[j][2]];
            if ((lstm_state[j][2] > -1024) && (lstm_state[j][2] < 0))
             lstm_state[j][2] = 4096 - lut_sigmoid[-lstm_state[j][2]];
            if (lstm_state[j][2] <= -1024)
             lstm_state[j][2] = 1;

            if (lstm_state[j][3] >= 1024)
             lstm_state[j][3] = 4096;
            if ((lstm_state[j][3] >= 0) && (lstm_state[j][3] < 1024))
             lstm_state[j][3] = lut_tanh[lstm_state[j][3]];
            if ((lstm_state[j][3] > -1024) && (lstm_state[j][3] < 0))
             lstm_state[j][3] = -lut_tanh[-lstm_state[j][3]];
            if (lstm_state[j][3] <= -1024)
             lstm_state[j][3] = -4096;
         ...
         if (h_state[j] >= 1024)
          h_state[j] = 4096;
         if ((h_state[j] >= 0) && (h_state[j] < 1024))
          h_state[j] = lut_tanh[h_state[j]];
         if ((h_state[j] > -1024) && (h_state[j] < 0))
          h_state[j] = -lut_tanh[-h_state[j]];
         if (h_state[j] <= -1024)
          h_state[j] = -4096;
        ...
        lstm_output = (int16)weight[20*4+20*20*4+20*4+20];
        for (j = 0; j < 20; ++j)
_ssdm_op_SpecPipeline(-1, 1, 1, 0, "");
 lstm_output += ((h_state[j] * (int16)weight[20*4+20*20*4+20*4+j]) >> 12);
