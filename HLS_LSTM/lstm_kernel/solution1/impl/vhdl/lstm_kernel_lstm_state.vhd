...
entity lstm_kernel_lstm_state_ram is 
    generic(
...
architecture rtl of lstm_kernel_lstm_state_ram is 
...
entity lstm_kernel_lstm_state is
    generic (
...
architecture arch of lstm_kernel_lstm_state is
    component lstm_kernel_lstm_state_ram is
        port (
            clk : IN STD_LOGIC;
...
begin
    lstm_kernel_lstm_state_ram_U :  component lstm_kernel_lstm_state_ram
    port map (
        clk => clk,
        addr0 => address0,
        ce0 => ce0,
