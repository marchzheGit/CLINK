...
proc sim {} {
	...
	set gWorkingDir          "../.."
	set constFileTvIn        "lstm_kernel.autotvin.dat"
	set constFileTvOut       "lstm_kernel.autotvout.dat"
	set constFileHdlTvIn     "lstm_kernel.autohdltvin.dat"
	set constFileHdlTvOut    "lstm_kernel.autohdltvout.dat"
	set gGateLevelSim        "0"
	set gAutowrap            "1"
	set gTool                "modelsim"
