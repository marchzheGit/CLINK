...
static  char aesl_internal_str[12] = "Test finish";
...
printf("\n\{ BEGIN @main\n");
if (AESL_DEBUG_TRACE)
printf("\n  %%1 = getelementptr inbounds [100 x i8]* %%file_name, i64 0, i64 0, !dbg !3 for 0x%I64xth hint within @main  --> \n", ++aesl_llvm_cbe_2_count);
...
if (AESL_DEBUG_TRACE)
printf("\n  %%3 = call %%struct._iobuf* @fopen(i8* %%1, i8* getelementptr inbounds ([2 x i8]* @aesl_internal_.str1, i64 0, i64 0)) nounwind, !dbg !3 for 0x%I64xth hint within @main  --> \n", ++aesl_llvm_cbe_4_count);
...
if (AESL_DEBUG_TRACE)
printf("\n  %%4 = call i32 (%%struct._iobuf*, i8*, ...)* @fscanf(%%struct._iobuf* %%3, i8* getelementptr inbounds ([3 x i8]* @aesl_internal_.str2, i64 0, i64 0), i32 undef) nounwind, !dbg !4 for 0x%I64xth hint within @main  --> \n", ++aesl_llvm_cbe_8_count);
...
if (AESL_DEBUG_TRACE)
printf("\n  %%puts = call i32 @puts(i8* getelementptr inbounds ([12 x i8]* @aesl_internal_str, i64 0, i64 0)), !dbg !4 for 0x%I64xth hint within @main  --> \n", ++aesl_llvm_cbe_puts_count);
...
if (AESL_DEBUG_TRACE)
printf("\n  %%5 = call i32 @fclose(%%struct._iobuf* %%3) nounwind, !dbg !4 for 0x%I64xth hint within @main  --> \n", ++aesl_llvm_cbe_9_count);
