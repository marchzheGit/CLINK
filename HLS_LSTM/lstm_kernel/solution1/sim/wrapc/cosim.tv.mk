...
$(ObjDir)/lstm_kernel_tb.c_pre.c.tb.o : lstm_kernel_tb.c_pre.c.tb.c $(ObjDir)/.dir
	$(Echo) "   Compiling (apcc) lstm_kernel_tb.c_pre.c.tb.c" $(AVE_DIR_DLOG)
	$(Verb) $(AUTOCC) -fno-builtin-isinf -fno-builtin-isnan -c $(IFLAG) $(DFLAG) $< -o $@; \

$(ObjDir)/lstm_kernel.c_pre.c.tb.o : lstm_kernel.c_pre.c.tb.c $(ObjDir)/.dir
	$(Echo) "   Compiling (apcc) lstm_kernel.c_pre.c.tb.c" $(AVE_DIR_DLOG)
	$(Verb) $(AUTOCC) -fno-builtin-isinf -fno-builtin-isnan -c $(IFLAG) $(DFLAG) $< -o $@; \
