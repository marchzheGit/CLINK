...
// ==============================================================
# 1 "E:/2018/180314_DC_LSTM/hls_lstm/lstm_kernel.c"
# 1 "E:/2018/180314_DC_LSTM/hls_lstm/lstm_kernel.c" 1
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 147 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "E:/2018/180314_DC_LSTM/hls_lstm/lstm_kernel.c" 2
# 1 "C:/Xilinx/Vivado/2019.1/include\\ap_cint.h" 1
# 67 "C:/Xilinx/Vivado/2019.1/include\\ap_cint.h"
...
# 68 "C:/Xilinx/Vivado/2019.1/include\\ap_cint.h" 2
...
# 69 "C:/Xilinx/Vivado/2019.1/include\\ap_cint.h" 2
# 83 "C:/Xilinx/Vivado/2019.1/include\\ap_cint.h"
# 1 "C:/Xilinx/Vivado/2019.1/include/etc/autopilot_apint.h" 1
# 57 "C:/Xilinx/Vivado/2019.1/include/etc/autopilot_apint.h"
# 1 "C:/Xilinx/Vivado/2019.1/include\\etc/autopilot_dt.h" 1
# 97 "C:/Xilinx/Vivado/2019.1/include\\etc/autopilot_dt.h"
# 1 "C:/Xilinx/Vivado/2019.1/include\\etc/autopilot_dt.def" 1
...
# 98 "C:/Xilinx/Vivado/2019.1/include\\etc/autopilot_dt.h" 2
# 1 "C:/Xilinx/Vivado/2019.1/include\\etc/autopilot_dt_ext.def" 1
...
# 99 "C:/Xilinx/Vivado/2019.1/include\\etc/autopilot_dt.h" 2
# 108 "C:/Xilinx/Vivado/2019.1/include\\etc/autopilot_dt.h"
# 1 "C:/Xilinx/Vivado/2019.1/include\\etc/autopilot_dt.def" 1
...
# 109 "C:/Xilinx/Vivado/2019.1/include\\etc/autopilot_dt.h" 2
# 1 "C:/Xilinx/Vivado/2019.1/include\\etc/autopilot_dt_ext.def" 1
...
# 110 "C:/Xilinx/Vivado/2019.1/include\\etc/autopilot_dt.h" 2
# 131 "C:/Xilinx/Vivado/2019.1/include\\etc/autopilot_dt.h"
typedef int __attribute__ ((bitwidth(64))) int64;
typedef unsigned int __attribute__ ((bitwidth(64))) uint64;
# 58 "C:/Xilinx/Vivado/2019.1/include/etc/autopilot_apint.h" 2
# 1 "C:/Xilinx/Vivado/2019.1/include\\etc/autopilot_ssdm_bits.h" 1
# 64 "C:/Xilinx/Vivado/2019.1/include\\etc/autopilot_ssdm_bits.h"
# 1 "C:/Xilinx/Vivado/2019.1/win64/tools/clang/bin/../lib/clang/3.1/../../../x86_64-w64-mingw32/include\\assert.h" 1 3
# 15 "C:/Xilinx/Vivado/2019.1/win64/tools/clang/bin/../lib/clang/3.1/../../../x86_64-w64-mingw32/include\\assert.h" 3
# 1 "C:/Xilinx/Vivado/2019.1/win64/tools/clang/bin/../lib/clang/3.1/../../../x86_64-w64-mingw32/include\\_mingw.h" 1 3
# 15 "C:/Xilinx/Vivado/2019.1/win64/tools/clang/bin/../lib/clang/3.1/../../../x86_64-w64-mingw32/include\\assert.h" 2 3
...
# 36 "C:/Xilinx/Vivado/2019.1/win64/tools/clang/bin/../lib/clang/3.1/../../../x86_64-w64-mingw32/include\\assert.h" 3
  void __cdecl __attribute__((noreturn)) abort(void);
# 45 "C:/Xilinx/Vivado/2019.1/win64/tools/clang/bin/../lib/clang/3.1/../../../x86_64-w64-mingw32/include\\assert.h" 3
extern void __cdecl
_wassert(const wchar_t *_Message,const wchar_t *_File,unsigned _Line);
extern void __cdecl
_assert (const char *_Message, const char *_File, unsigned _Line);
# 65 "C:/Xilinx/Vivado/2019.1/include\\etc/autopilot_ssdm_bits.h" 2
...
# 326 "C:/Xilinx/Vivado/2019.1/win64/tools/clang/bin/../lib/clang/3.1/../../../x86_64-w64-mingw32/include\\stdlib.h" 3
...
# 73 "C:/Xilinx/Vivado/2019.1/include\\etc/autopilot_ssdm_bits.h" 2
# 59 "C:/Xilinx/Vivado/2019.1/include/etc/autopilot_apint.h" 2
# 84 "C:/Xilinx/Vivado/2019.1/include\\ap_cint.h" 2
# 2 "E:/2018/180314_DC_LSTM/hls_lstm/lstm_kernel.c" 2
# 1 "E:/2018/180314_DC_LSTM/hls_lstm/lstm_kernel.h" 1
# 20 "E:/2018/180314_DC_LSTM/hls_lstm/lstm_kernel.h"
void lstm_kernel(
 uint1 mode,
 int24 sampleinput,
 uint8 scale_fac,
 uint8 scale_mul,
 int32 weight[64*4+64*64*4+64*4+64 +64],
    volatile int16 *lstm_out);
# 3 "E:/2018/180314_DC_LSTM/hls_lstm/lstm_kernel.c" 2
...
#pragma HLS RESOURCE variable=weight core=RAM_1P_BRAM
 ...
 static int16 h_state[64] = {0};
    static int16 c_state[64] = {0};
...
#pragma HLS reset variable=c_state
 ...
 int16 lstm_output;
    ...
    static int16 weight_l[4+4*64 +4][64];
#pragma HLS array_partition variable=weight_l dim=2 factor=50

 int16 lstm_state[64][4];
#pragma HLS array_partition variable=lstm_state dim=1 factor=50

 if (mode == 1) {

        for (j = 0; j < 64; ++j) {
            weight_l[0][j] = (int16)weight[64*0+j];
         weight_l[1][j] = (int16)weight[64*1+j];
         weight_l[2][j] = (int16)weight[64*2+j];
         weight_l[3][j] = (int16)weight[64*3+j];
        }

        for (i = 0; i < 64; ++i) {
         for (j = 0; j < 64; ++j) {
          weight_l[4+4*i+0][j] = (int16)weight[64*4+64*64*0+j*64 +i];
          weight_l[4+4*i+1][j] = (int16)weight[64*4+64*64*1+j*64 +i];
          weight_l[4+4*i+2][j] = (int16)weight[64*4+64*64*2+j*64 +i];
          weight_l[4+4*i+3][j] = (int16)weight[64*4+64*64*3+j*64 +i];
         }
        }

        for (j = 0; j < 64; ++j) {
         weight_l[4+4*64 +0][j] = (int16)weight[64*4+64*64*4+64*0+j];
         weight_l[4+4*64 +1][j] = (int16)weight[64*4+64*64*4+64*1+j];
         weight_l[4+4*64 +2][j] = (int16)weight[64*4+64*64*4+64*2+j];
         weight_l[4+4*64 +3][j] = (int16)weight[64*4+64*64*4+64*3+j];
        }
    }
    else {
     offset = (1 << (scale_fac - 1));
     sampleinput_16b = (int16) ((sampleinput * scale_mul + offset) >> (scale_fac - 12));

     for (i = 0; i < 4; ++i) {
#pragma HLS pipeline
 for (j = 0; j < 64; ++j) {
#pragma HLS unroll
 lstm_state[j][i] = (sampleinput_16b * weight_l[i][j]) >> 12;
      }
     }
...
#pragma HLS pipeline
 for (j = 0; j < 64; ++j) {
#pragma HLS unroll
 lstm_state[j][i] += weight_l[4+4*64 +i][j];
...
#pragma HLS pipeline
 c_state[j] = (((c_state[j] * lstm_state[j][1]) >> 8) + ((lstm_state[j][3] * lstm_state[j][0]) >> 12)) >> 4;
        ...
        lstm_output = (int16)weight[64*4+64*64*4+64*4+64];
        for (j = 0; j < 64; ++j)
#pragma HLS pipeline
 lstm_output += ((h_state[j] * (int16)weight[64*4+64*64*4+64*4+j]) >> 12);
