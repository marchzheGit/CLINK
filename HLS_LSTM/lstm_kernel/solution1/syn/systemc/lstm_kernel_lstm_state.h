...
// ==============================================================
#ifndef __lstm_kernel_lstm_state_H__
#define __lstm_kernel_lstm_state_H__
...
struct lstm_kernel_lstm_state_ram : public sc_core::sc_module {
...
sc_core::sc_signal<sc_lv<DataWidth> > q1_t1;
   SC_CTOR(lstm_kernel_lstm_state_ram) {
...
SC_MODULE(lstm_kernel_lstm_state) {
...
lstm_kernel_lstm_state_ram* meminst;


SC_CTOR(lstm_kernel_lstm_state) {
meminst = new lstm_kernel_lstm_state_ram("lstm_kernel_lstm_state_ram");
