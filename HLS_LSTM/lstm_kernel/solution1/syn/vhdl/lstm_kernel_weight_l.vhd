...
entity lstm_kernel_weight_l_ram is 
    generic(
            MEM_TYPE    : string := "block"; 
            DWIDTH     : integer := 16; 
            AWIDTH     : integer := 11; 
            MEM_SIZE    : integer := 1760
    ); 
    port (
...
architecture rtl of lstm_kernel_weight_l_ram is 
...
entity lstm_kernel_weight_l is
    generic (
        DataWidth : INTEGER := 16;
        AddressRange : INTEGER := 1760;
...
architecture arch of lstm_kernel_weight_l is
    component lstm_kernel_weight_l_ram is
        port (
            clk : IN STD_LOGIC;
...
begin
    lstm_kernel_weight_l_ram_U :  component lstm_kernel_weight_l_ram
    port map (
        clk => clk,
        addr0 => address0,
        ce0 => ce0,
